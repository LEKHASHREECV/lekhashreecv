...
<body><!--_________________sidenav_______________-->
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
    ...
    <!--   __________________________search bar_____________________________-->
<div class="srch">
...
<!--______________request book__________-->
<div class="srch">
    <form class="navbar-form" method="post" name="form1">
...
if(isset($_POST['submit1']))
{
 ...
 <?php
  ...
  else
  {
    ?>
    <script type="text/javascript">
alert(" you need to login to request book ");
    </script>
    <?php
  }
}
