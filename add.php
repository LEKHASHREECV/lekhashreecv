...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
    ...
    <form class="book" action="" method="post">
        ...
        <input type="text" name="addition" class="form-control" placeholder="addition" required=""><br>
...
<?php
    if(isset($_POST['submit']))
    {
      if(isset($_SESSION['login_user']))
      {
        mysqli_query($db,"INSERT INTO books VALUES ('$_POST[bid]', '$_POST[name]', '$_POST[authors]', '$_POST[addition]', '$_POST[status]', '$_POST[quantity]', '$_POST[department]') ;");
        ?>
